...
namespace Blog.Data.EntityFramework.Migrations
{
    ...
    [Migration("20170321050759_CategoryAddDescriptionRelation")]
    partial class CategoryAddDescriptionRelation
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Blog.Core.Entities.BlogStoryCategory", b =>
                {
                    b.Property<int>("BlogStoryId");

                    b.Property<int>("CategoryId");

                    b.HasKey("BlogStoryId", "CategoryId");

                    b.HasIndex("CategoryId");

                    b.ToTable("BlogStoryCategory");
                });
            ...
            modelBuilder.Entity("Blog.Core.Entities.BlogStory", b =>
                {
                    b.HasOne("Blog.Core.Entities.User", "Autor")
