...
using Blog.Core.Identity.Services;
...
namespace Blog.Core.Identity.Managers
{
    /// <summary>
    ...
    public class UserManager<TUser> : IDisposable where TUser : class
    {
        ...
        private readonly Dictionary<String, Contracts.IUserTwoFactorTokenProvider<TUser>> _tokenProviders =
            new Dictionary<String, Contracts.IUserTwoFactorTokenProvider<TUser>>();
        ...
        /// <param name="userValidators">A collection of <see cref="Contracts.IUserValidator{TUser}"/> to validate users against.</param>
        /// <param name="passwordValidators">A collection of <see cref="Contracts.IPasswordValidator{TUser}"/> to validate passwords against.</param>
        ...
        public UserManager(IUserStore<TUser> store,
            ...
            IEnumerable<Contracts.IUserValidator<TUser>> userValidators,
            IEnumerable<Contracts.IPasswordValidator<TUser>> passwordValidators,
            ...
            if (services != null)
            {
                ...
                foreach (var providerName in Options.Tokens.ProviderMap.Keys)
                {
                    ...
                    var provider = (description.ProviderInstance ?? services.GetRequiredService(description.ProviderType))
                        as Contracts.IUserTwoFactorTokenProvider<TUser>;
                    if (provider != null)
                    {
        ...
        /// <summary>
        /// The <see cref="Contracts.IUserValidator{TUser}"/> used to validate users.
        /// </summary>
        protected internal IList<Contracts.IUserValidator<TUser>> UserValidators { get; } = new List<Contracts.IUserValidator<TUser>>();

        /// <summary>
        /// The <see cref="Contracts.IPasswordValidator{TUser}"/> used to validate passwords.
        /// </summary>
        protected internal IList<Contracts.IPasswordValidator<TUser>> PasswordValidators { get; } = new List<Contracts.IPasswordValidator<TUser>>();
        ...
        /// </value>
        public virtual Boolean SupportsUserAuthenticationTokens
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserTwoFactor
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserPassword
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserSecurityStamp
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserRole
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserLogin
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserEmail
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserPhoneNumber
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserClaim
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsUserLockout
        {
            get
            {
                ThrowIfDisposed();
        ...
        /// </value>
        public virtual Boolean SupportsQueryableUsers
        {
            get
            {
                ThrowIfDisposed();
        ...
        public virtual Int32 GetUserIdInt32(ClaimsPrincipal principal)
        {
            var idString = GetUserId(principal);
            Int32 id;
        ...
        public virtual async Task<Boolean> CheckPasswordAsync(TUser user, String password)
        {
            ThrowIfDisposed();
            var passwordStore = GetPasswordStore();
            if (user == null)
        ...
        /// otherwise false.
        /// </returns>
        public virtual Task<Boolean> HasPasswordAsync(TUser user)
        {
            ThrowIfDisposed();
            var passwordStore = GetPasswordStore();
            if (user == null)
        ...
        /// </returns>
        public virtual async Task<Boolean> IsInRoleAsync(TUser user, String role)
        {
            ThrowIfDisposed();
            var userRoleStore = GetUserRoleStore();
            if (user == null)
        ...
        /// </returns>
        public virtual async Task<Boolean> IsEmailConfirmedAsync(TUser user)
        {
            ThrowIfDisposed();
            var store = GetEmailStore();
            if (user == null)
        ...
        /// </returns>
        public virtual Task<Boolean> IsPhoneNumberConfirmedAsync(TUser user)
        {
            ThrowIfDisposed();
            var store = GetPhoneNumberStore();
            if (user == null)
        ...
        /// </returns>
        public virtual async Task<Boolean> VerifyChangePhoneNumberTokenAsync(TUser user, String token, String phoneNumber)
        {
            ThrowIfDisposed();
        ...
        /// is valid, otherwise false.
        /// </returns>
        public virtual async Task<Boolean> VerifyUserTokenAsync(TUser user, String tokenProvider, String purpose, String token)
        {
            ThrowIfDisposed();
            if (user == null)
            {
        ...
        public virtual void RegisterTokenProvider(String providerName, Contracts.IUserTwoFactorTokenProvider<TUser> provider)
        {
            ThrowIfDisposed();
            if (provider == null)
            {
        ...
        /// otherwise false.
        /// </returns>
        public virtual async Task<Boolean> VerifyTwoFactorTokenAsync(TUser user, String tokenProvider, String token)
        {
            ThrowIfDisposed();
            if (user == null)
            {
        ...
        /// </returns>
        public virtual async Task<Boolean> GetTwoFactorEnabledAsync(TUser user)
        {
            ThrowIfDisposed();
        ...
        /// </returns>
        public virtual async Task<IdentityResult> SetTwoFactorEnabledAsync(TUser user, Boolean enabled)
        {
            ThrowIfDisposed();
            var store = GetUserTwoFactorStore();
            if (user == null)
        ...
        /// </returns>
        public virtual async Task<Boolean> IsLockedOutAsync(TUser user)
        {
            ThrowIfDisposed();
        ...
        /// The <see cref="Task"/> that represents the asynchronous operation, the <see cref="IdentityResult"/> of the operation
        /// </returns>
        public virtual async Task<IdentityResult> SetLockoutEnabledAsync(TUser user, Boolean enabled)
        {
            ThrowIfDisposed();
            var store = GetUserLockoutStore();
            if (user == null)
        ...
        /// </returns>
        public virtual async Task<Boolean> GetLockoutEnabledAsync(TUser user)
        {
            ThrowIfDisposed();
            var store = GetUserLockoutStore();
            if (user == null)
        ...
        public virtual async Task<Int32> GetAccessFailedCountAsync(TUser user)
        {
            ThrowIfDisposed();
            var store = GetUserLockoutStore();
            if (user == null)
        ...
        internal IUserEmailStore<TUser> GetEmailStore(Boolean throwOnFail = true)
        {
        ...
        internal async Task<IdentityResult> UpdatePasswordHash(IUserPasswordStore<TUser> passwordStore,
            TUser user, String newPassword, Boolean validatePassword = true)
        {
            if (validatePassword)
            {
