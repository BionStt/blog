...
using Blog.Core.Identity.Entities;
...
namespace Blog.Core.Identity.Managers
{
    ...
    public class SignInManager<TUser> where TUser : class
    {
        ...
        public virtual Boolean IsSignedIn(ClaimsPrincipal principal)
        {
            if (principal == null)
            {
        ...
        /// </returns>
        public virtual async Task<Boolean> CanSignInAsync(TUser user)
        {
        ...
        /// <returns>The task object representing the asynchronous operation.</returns>
        public virtual Task SignInAsync(TUser user, Boolean isPersistent, String authenticationMethod = null)
        {
        ...
        /// for the sign-in attempt.</returns>
        /// <returns></returns>
        public virtual async Task<SignInResult> CheckPasswordSignInAsync(TUser user, String password, Boolean lockoutOnFailure)
        {
            if (user == null)
            {
                throw new ArgumentNullException(nameof(user));
        ...
        /// </returns>
        public virtual async Task<Boolean> IsTwoFactorClientRememberedAsync(TUser user)
        {
        ...
        /// <returns>The task object representing the asynchronous operation containing the <see name="SignInResult"/>
        /// for the sign-in attempt.</returns>
        public virtual async Task<SignInResult> TwoFactorSignInAsync(String provider, String code, Boolean isPersistent,
        ...
        /// <returns>The task object representing the asynchronous operation containing the <see name="SignInResult"/>
        /// for the sign-in attempt.</returns>
        public virtual Task<SignInResult> ExternalLoginSignInAsync(String loginProvider, String providerKey, Boolean isPersistent)
        ...
        /// <returns>The task object representing the asynchronous operation containing the <see name="SignInResult"/>
        /// for the sign-in attempt.</returns>
        public virtual async Task<SignInResult> ExternalLoginSignInAsync(String loginProvider, String providerKey, Boolean isPersistent, Boolean bypassTwoFactor)
        {
        ...
        public virtual async Task<ExternalLoginInfo> GetExternalLoginInfoAsync(String expectedXsrf = null)
        {
            ...
            foreach (var restriction in _loginRestriction)
            {
                if(provider.Equals(restriction.ProviderName, StringComparison.Ordinal))
                {
                    var login = auth.Principal.Claims.FirstOrDefault(x => x.Type == restriction.PrincipalType);
                    if (login == null || !login.Value.Equals(restriction.Login, StringComparison.Ordinal))
                        return null;
                }
            }
        ...
        private async Task<SignInResult> SignInOrTwoFactorAsync(TUser user, Boolean isPersistent, String loginProvider = null, Boolean bypassTwoFactor = false)
        {
            if (!bypassTwoFactor &&
        ...
        protected virtual async Task<Boolean> IsLockedOut(TUser user)
        {
